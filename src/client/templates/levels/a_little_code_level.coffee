...
launchButtonBackground = level.elements.launchButtonBackground = $(document.createElement("DIV"))
...
launchButton.css
    ...
    background: '-webkit-radial-gradient(50% 50%, circle contain, #CAE6CA, #62C462)'
    position: 'absolute'
    top: '400px'
    left: '70px'
    width: '40px'

...
exports.b2Contact = b2Contact = class b2Contact
    constructor:  (s1, s2) ->
    ...
    GetManifoldCount: () -> return @m_manifoldCount
    
    GetNext: () -> return @m_next
    
    GetShape1: () -> return @m_shape1
    
    GetShape2: () -> return @m_shape2
...
b2Contact.AddType = (createFcn, destroyFcn, type1, type2) ->
...
b2Contact.InitializeRegisters = () ->
    ...
    for i in [0...b2Shape.e_shapeTypeCount]
    	...
    	b2Contact.s_registers[i][j] = new b2ContactRegister() for j in [0...b2Shape.e_shapeTypeCount]
...
b2Contact.Create = (shape1, shape2, allocator) ->

  ...
  (function($) {
    ...
    Peanutty = (function() {
      ...
      Peanutty.prototype.sendCodeMessage = function(arg) {
        ...
        activeEditor = ((function() {
          ...
          ref = [this.scriptEditor, this.levelEditor, this.environmentEditor];
          results = [];
          for (j = 0, len = ref.length; j < len; j++) {
            editor = ref[j];
            if (editor.container.offsetLeft !== 0) {
              results.push(editor.container);
            }
          }
          return results;
        }).call(this))[0];
        if (activeEditor == null) {
          activeEditor = this.scriptEditor;
        }
    ...
    Peanutty.runCode = (function(_this) {
      return function(editor) {
        var active, catchCode, catches, code, complete, error, indent, index, j, len, segment, segments, tab, time;
    ...
    Peanutty.createEnvironment = (function(_this) {
      return function(environmentEditor) {

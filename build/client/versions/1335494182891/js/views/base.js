...
(function() {
  ...
  (function($) {
    var empty, ref, remove, replaceWith, triggerRemoveEvent, view, views;
    views = provide('views', {});
    ...
    ref = $(''), empty = ref.empty, remove = ref.remove, replaceWith = ref.replaceWith;
    ...
    return views.BaseView = (function() {
      ...
      function BaseView(options) {
        ...
        ref1 = ['prepare', 'ready', 'render', 'loading', 'error', 'build', 'complete', 'destroy'];
        ...
        if (!el.length) {
          ...
          if (type) {
            ...
            if (type === 'text/javascript') {
              ...
              this._loadingStarted();
              el.bind('load', (function(_this) {
                return function() {
                  return _this._loadingFinished();
                };
              })(this));
              el.bind('abort', (function(_this) {
                return function() {
              ...
              $.ajax({
                ...
                error: (function(_this) {
                  return function(xhr, status, e, data) {
                    _this.errors.push(['requireElement', url, tag, type, rel]);
                    return _this._loadingFinished();
                  };
                })(this)

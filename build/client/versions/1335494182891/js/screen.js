...
(function() {
  (function($) {
    ...
    Screen = (function() {
      ...
      function Screen(arg) {
        var scale;
        this.canvas = arg.canvas, scale = arg.scale;
      ...
      Screen.prototype.panDirection = function(arg) {
        var callback, distance, move, scaledDistance, stepDistance, time, vertical;
        distance = arg.distance, time = arg.time, vertical = arg.vertical, callback = arg.callback;
        time || (time = 0);
      ...
      Screen.prototype.pan = function(arg) {
        var _callback, callback, returnCount, time, x, y;
        x = arg.x, y = arg.y, time = arg.time, callback = arg.callback;
      ...
      Screen.prototype.zoom = function(arg) {
        var adjustScale, callback, out, percentage, scale, step, time;
        scale = arg.scale, percentage = arg.percentage, out = arg.out, time = arg.time, callback = arg.callback;
        time || (time = 0);
        if (scale == null) {
      ...
      Screen.prototype.render = function(world) {
        var aabb, b, b1, b2, bp, c, cA, cB, color, contact, f, fixtureA, fixtureB, flags, i, invQ, j, results, s, vs, x1, x2, xf;

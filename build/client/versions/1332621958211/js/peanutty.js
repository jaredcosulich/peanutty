  ...
  (function($) {
    ...
    Peanutty = (function() {
      ...
      Peanutty.prototype.sendCodeMessage = function(_arg) {
        ...
        if (activeEditor == null) activeEditor = this.scriptEditor;
      ...
      Peanutty.prototype.createPoly = function(_arg) {
        ...
        for (_i = 0, _len = fixtureDefs.length; _i < _len; _i++) {
          ...
          if (fixtureDef.userData == null) fixtureDef.userData = userData;
          if (fixtureDef.drawData == null) fixtureDef.drawData = drawData;
    ...
    Peanutty.sendCodeMessage = function(_arg) {
      var message;
      message = _arg.message;

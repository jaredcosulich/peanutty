...
(function($) {
  ...
  Peanutty = (function() {
    ...
    Peanutty.prototype.addToScript = function(_arg) {
      ...
      this.scriptEditor.insert("\n" + command + "\n");
      return $.timeout(10, __bind(function() {
        var commandElements, commandLength, lines;
        commandLength = command.split("\n").length;
        lines = $(this.scriptEditor.container).find(".ace_line");
        commandElements = $(lines.slice(lines.length - commandLength - 1, lines.length - 1));
        commandElements.addClass('highlight');
        return $.timeout(1000, __bind(function() {
          return $(this.scriptEditor.container).find(".ace_line").removeClass('highlight');
        }, this));
      }, this));
    };
    ...
    Peanutty.prototype.sendCodeMessage = function(_arg) {
      ...
      return $.timeout(500, __bind(function() {
        return this.codeMessage.removeClass('highlight');
      }, this));
    };
  ...
  Peanutty.runCode = __bind(function(editor) {
  ...
  Peanutty.runScript = __bind(function(scriptEditor) {
    if (scriptEditor == null) {
      scriptEditor = view.scriptEditor;
    }
    return Peanutty.runCode(scriptEditor);
  }, this);
  Peanutty.setStage = __bind(function(stageEditor) {
    if (stageEditor == null) {
      stageEditor = view.stageEditor;
    }
    return Peanutty.runCode(stageEditor);
  }, this);
  Peanutty.loadEnvironment = __bind(function(environmentEditor) {
    ...
    Home.prototype.renderView = function() {
      ...
      $('.topbar a').bind('click', function(e) {
        ...
        if (currentRoute.indexOf('stage') > -1) {
          return $.timeout(5, __bind(function() {
      ...
      this.loadCode();
      if (this.data.stage != null) {
        this.loadNewStage(this.data.stage);
      }
      return Peanutty.runScript();
    };

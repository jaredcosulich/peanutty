...
(function($) {
  ...
  Peanutty = (function() {
    ...
    Peanutty.prototype.initContactListeners = function() {
      ...
      beginContact = __bind(function(contact) {
        var listener, _i, _len, _ref, _results;
        _ref = this.beginContactListeners;
        _results = [];
    ...
    Peanutty.prototype.sendCodeMessage = function(_arg) {
      ...
      closeLink.html('x');
      closeLink.bind('click', __bind(function() {
        return this.codeMessage.removeClass('expanded');
      }, this));
      ...
      activeEditor = ((function() {
        ...
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          editor = _ref[_i];
          if (editor.container.offsetLeft !== 0) {
            _results.push(editor.container);
          }
        }
        return _results;
      }).call(this))[0];
  ...
  Peanutty.loadLevel = __bind(function(levelEditor) {
    if (levelEditor == null) {
      levelEditor = view.levelEditor;
    }
    return Peanutty.runCode(levelEditor);
  }, this);
  Peanutty.createEnvironment = __bind(function(environmentEditor) {
